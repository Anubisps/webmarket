      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold">
            Edit <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">FAQ</span>
          </h1>
          <p className="text-gray-400 text-lg">Update this frequently asked question.</p>
        </div>
        <Link
